...
try:
    ...
    print("✅ LSTM forecast loaded from models/future_forecast.pkl")
except FileNotFoundError:
    raise FileNotFoundError("❌ File not found: models/future_forecast.pkl")
...
plt.close()
print("📊 Efficient Frontier saved to assets/figures/efficient_frontier.png")
...
print("🔹 Maximum Sharpe Portfolio (Risk-Adjusted Return):")
